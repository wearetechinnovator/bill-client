...
const DebitNote = ({ mode }) => {
	...
	const [formData, setFormData] = useState({
		...
		purchaseInvoice: '', items: ItemRows, additionalCharge: additionalRows, note: '', terms: `1. Price: Rates are firm and final as per PO. No extra charges will be accepted unless approved
in writing.
