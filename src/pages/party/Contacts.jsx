...
const Contacts = ({ partyId }) => {
        ...
        (async () => {
            try {
                ...
                const req = await fetch(URL, {
                    ...
                    body: JSON.stringify({ id: editId, token })
                })
                const res = await req.json();
    ...
    const deleteContact = async (id) => {
        try {
            ...
            setAllContacts(prev => prev.filter(p => p._id !== id));
            ...
            >
                ...
                <Drawer.Body>
                    ...
                    <div className='w-full flex justify-center gap-3 my-3 mt-5 '>
                        <button
                            onClick={loading ? null : (editId ? updateContact : saveContact)}
